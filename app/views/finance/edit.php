    ...
    <div class="row g-4 mb-4">
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    <h2 class="fw-bold mb-1" style="color: var(--text-primary); font-family: 'Poppins', sans-serif;">Edit Transaksi</h2>
                    <p class="mb-0" style="color: var(--text-tertiary); font-size: 0.9rem;">Perbarui informasi transaksi keuangan</p>
                </div>
        ...
        <div class="col-12 col-lg-8 mx-auto">
            <div class="table-card">
                <div class="table-card-header">
                    <h5>Formulir Edit Transaksi</h5>
                </div>
                <div class="p-4">
                    <form action="<?= base_url('finance/update/' . $transaction['id']) ?>" method="POST">
                        <div class="row g-4">
                            <!-- Tipe Transaksi (Read Only) -->
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color: var(--text-primary);">Tipe Transaksi</label>
                                <input type="text" value="<?= $transaction['type'] === 'income' ? '💰 Pemasukan' : '💸 Pengeluaran' ?>" readonly class="form-control-custom" style="background: var(--surface-2);">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="category" value="<?= $transaction['category'] ?>" class="form-control-custom" required placeholder="Contoh: Penjualan, Gaji, Utilitas, Sewa">
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="amount" value="<?= $transaction['amount'] ?>" class="form-control-custom" required placeholder="0" min="0" step="0.01" style="border-left: none;">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="date" name="transaction_date" value="<?= $transaction['transaction_date'] ?>" class="form-control-custom" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control-custom" rows="4" placeholder="Deskripsi detail transaksi..."><?= $transaction['description'] ?? '' ?></textarea>
