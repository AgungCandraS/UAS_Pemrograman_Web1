<div class="fade-in">
    ...
    <div class="mb-5">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
            <div>
                <h1 class="fw-800 mb-2" style="color: var(--text-primary); font-family: 'Poppins', sans-serif; font-size: 2.2rem;">➕ Tambah Produk Baru</h1>
                <p class="mb-0" style="color: var(--text-secondary); font-size: 1rem;">Isi formulir di bawah untuk menambahkan produk ke inventory Anda</p>
            </div>
    ...
    <div style="background: var(--surface-1); border: 1px solid var(--border-color); border-radius: 14px; overflow: hidden; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.2);">
        ...
        <div style="background: linear-gradient(90deg, var(--primary) 0%, var(--secondary) 100%); padding: 1.5rem; color: white;">
            <h5 style="margin: 0; font-weight: 600; font-size: 1.1rem;">📋 Formulir Data Produk</h5>
        </div>

        <!-- Form Content -->
        <div style="padding: 2rem;">
            <form action="<?= base_url('inventory/store') ?>" method="POST" enctype="multipart/form-data" id="productForm">
                <div class="row g-4">
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div style="background: var(--surface-2); border: 1px solid var(--border-color); border-radius: 12px; padding: 1.5rem; margin-bottom: 1.5rem;">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="name" required placeholder="Contoh: Laptop Dell XPS 15" class="form-input-modern">
                                </div>

                                <div class="col-12 col-md-6">
                                    <label class="form-label-modern">SKU <span style="color: var(--danger);">*</span></label>
                                    <input type="text" name="sku" required placeholder="Contoh: PROD-001" class="form-input-modern">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" rows="4" placeholder="Deskripsi detail tentang produk..." class="form-input-modern"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div style="position: relative;">
                                        ...
                                        <input type="number" name="cost_price" required placeholder="0" min="0" step="0.01" class="form-input-modern" style="padding-left: 2.5rem;">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div style="position: relative;">
                                        <span style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: var(--text-secondary);">Rp</span>
                                        <input type="number" name="price" required placeholder="0" min="0" step="0.01" class="form-input-modern" style="padding-left: 2.5rem;">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(5, 150, 105, 0.15) 100%); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 8px; padding: 1rem; margin-top: 0.5rem;">
                                        <p style="margin: 0; color: var(--text-secondary); font-size: 0.9rem;">Margin Keuntungan: <strong id="marginDisplay" style="color: var(--success);">-</strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: var(--surface-2); border: 1px solid var(--border-color); border-radius: 12px; padding: 1.5rem;">
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-md-6">
                                    <label class="form-label-modern">Stok Awal <span style="color: var(--danger);">*</span></label>
                                    <input type="number" name="stock" required placeholder="0" min="0" class="form-input-modern">
                                </div>

                                <div class="col-12 col-md-6">
                                    <label class="form-label-modern">Stok Minimum (Alert) <span style="color: var(--danger);">*</span></label>
                                    <input type="number" name="min_stock" required placeholder="10" min="0" value="10" class="form-input-modern">
                                </div>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div style="background: var(--surface-2); border: 2px dashed var(--border-color); border-radius: 12px; padding: 2rem; text-align: center; margin-bottom: 1.5rem; transition: all 0.3s ease;" id="dropZone">
                            <div id="imagePreviewContainer">
                                <i class="fas fa-image" style="font-size: 2.5rem; color: var(--text-muted); margin-bottom: 1rem; display: block;"></i>
                                <p style="color: var(--text-secondary); margin-bottom: 0.5rem; font-weight: 500;">Pilih atau Drag Gambar</p>
                                <p style="color: var(--text-muted); font-size: 0.85rem; margin-bottom: 1rem;">PNG, JPG, GIF max 5MB</p>
                        ...
                        <!-- Summary Card -->
                        <div style="background: linear-gradient(135deg, var(--primary) 0%, var(--secondary) 100%); border-radius: 12px; padding: 1.5rem; color: white;">
                            <h6 style="margin: 0 0 1rem 0; font-weight: 600;">📊 Ringkasan Form</h6>
                            <div style="font-size: 0.9rem; line-height: 1.8;">
                                ...
                                <div style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid rgba(255,255,255,0.2);">
                                    <span>SKU:</span>
                                    <span id="summarySKU" style="font-weight: 600;">-</span>
                                </div>
                                <div style="display: flex; justify-content: space-between; padding: 0.5rem 0; border-bottom: 1px solid rgba(255,255,255,0.2);">
                                    <span>Harga Jual:</span>
                                    <span id="summaryPrice" style="font-weight: 600;">Rp-</span>
                                </div>
                                <div style="display: flex; justify-content: space-between; padding: 0.5rem 0;">
                                    <span>Stok Awal:</span>
                                    <span id="summaryStock" style="font-weight: 600;">-</span>
                                </div>
                            </div>
                        </div>
                    </div>
