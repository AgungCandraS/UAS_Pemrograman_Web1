    ...
    <div class="row g-4 mb-4">
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    <h2 class="fw-bold mb-1" style="color: var(--text-primary); font-family: 'Poppins', sans-serif;">
                        👥 HR & Penggajian Borongan
                    </h2>
                    <p class="mb-0" style="color: var(--text-tertiary); font-size: 0.9rem;">
                        Kelola karyawan, produksi & gaji borongan (Rajut & Linking)
                    </p>
                </div>
                <div class="dropdown">
                    <button class="btn-custom btn-primary-custom dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="fas fa-plus me-2"></i>Tambah Data
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?= base_url('hr/create') ?>">
                            <i class="fas fa-user-plus me-2"></i>Karyawan Baru
                        </a></li>
                        <li><a class="dropdown-item" href="<?= base_url('hr/production/create') ?>">
                            <i class="fas fa-clipboard-list me-2"></i>Input Produksi
                        </a></li>
                        <li><a class="dropdown-item" href="<?= base_url('hr/payroll/create') ?>">
                            <i class="fas fa-money-bill-wave me-2"></i>Generate Gaji
                        </a></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card hover-lift">
                ...
                <small class="text-success"><i class="fas fa-user-check"></i> <?= $stats['active_employees'] ?? 0 ?> Aktif</small>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card hover-lift">
                ...
                <h2 class="stat-card-value"><?= $stats['total_products'] ?? 0 ?></h2>
                <small class="text-muted">Belle, K5, K4, Kulot</small>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card hover-lift">
                ...
                <p class="stat-card-title">Gaji Pending</p>
                <h2 class="stat-card-value"><?= $stats['pending_payroll'] ?? 0 ?></h2>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card hover-lift">
                ...
                <p class="stat-card-title">Total Pending</p>
                <h2 class="stat-card-value"><?= format_currency($stats['total_pending_salary'] ?? 0) ?></h2>
    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        ...
        <li class="nav-item">
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#products">
                <i class="fas fa-boxes me-2"></i>Jenis Produk & Tarif
            </button>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url('hr/production') ?>">
                <i class="fas fa-clipboard-list me-2"></i>Produksi
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url('hr/payroll') ?>">
